...
public class HttpTransfer  
	...
	// faut pas cherhcer http://localhost:8080//data/25966a30-db9b-31db-9f4a-492d005f0c4a
	String url = "http://" + remote_protocol.getserver() + ":" +  remote_protocol.getport() + "/" + remote_protocol.getpath() + "/" + remote_locator.getref();
