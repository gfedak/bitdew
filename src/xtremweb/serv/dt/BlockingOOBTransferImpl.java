...
/**
 * <code>BlockingOOBTransferImpl</code> is an abstract class
 * implementing BlockingOOBTransfer when the API relies on a Blocking API.
 * In this case send and receive operations are executed in a separate
 * thread. 
 *
 ...
 * @version 1.0
 */
public abstract class BlockingOOBTransferImpl 
    extends OOBTransferImpl 
    implements OOBTransfer, BlockingOOBTransfer {



    /**
     * <code>runner</code> is a TransferThread which helps to
     * implements non blocking method  on top of blocking method.
     *
     */
    ...
    /**
     * <code>sendSenderSide</code> executes the
     * blockingSendSenderSide method in a separate Thread. 
     *
    ...
    /**
     * <code>receiveReceiverSide</code>  executes the
     * blockingReceiveReceiver method in a separate Thread.
     *
     * @exception OOBException if an error occurs
     */
